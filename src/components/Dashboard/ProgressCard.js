...
function ProgressCard({ userStudentDetails }) {
    ...
    return (
        ...
        >
            ...
            <p className="quest-message">The Google Cloud Ready Facilitator Program 2022 has officially been concluded. It has been such an incredible journey and we applaud you for all your efforts and hardwork.😊</p>
        </StyledProgressCard>
    );
}
